...
export class AppBddProvider {
  ...
  private createTables(): void {
    ...
    .then(() => {
      ...
      this.db.executeSql('CREATE TABLE IF NOT EXISTS `transactions` ( `id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, `amount` NUMERIC NOT NULL, `created_at` TEXT NOT NULL, `id_fest` INTEGER NOT NULL, `name_fest` TEXT NOT NULL, `id_com` INTEGER NOT NULL, `name_com` TEXT NOT NULL, `entities` INTEGER, `checked` INTEGER NOT NULL DEFAULT 0, FOREIGN KEY(`entities`) REFERENCES transactions_entries ( id ) )', [])
